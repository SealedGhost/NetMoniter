...
//
#define GUI_NUMBYTES  (1024*700*4) //(1024 * 1024) * 12  // x MByte   
//
...
// #ifdef __ICCARM__
//   #pragma location="GUI_RAM"
//   static __no_init U16 _aMemory[GUI_NUMBYTES / 4];
// #endif
// #ifdef __CC_ARM
//   U16 static _aMemory[GUI_NUMBYTES / 4] __attribute__ ((section ("GUI_RAM"), zero_init));
// #endif
// #ifdef __GNUC__
//   U16 static _aMemory[GUI_NUMBYTES / 4] __attribute__ ((section(".GUI_RAM"))) = { 0 };
// #endif
// #ifdef _WINDOWS
//   static U16 _aMemory[GUI_NUMBYTES / 4];
// #endif
	
// 	static U32 *aMemory;
// 	_aMemory = (U32 *)SDRAM_BASE_ADDR;
/*********************************************************************
*
*       Public code
*
