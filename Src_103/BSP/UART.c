...
uint8_t Uart_Rx[UART_RX_LEN];//UART1接收
...
{	
  GPIO_InitTypeDef GPIO_InitStructure;
    ...
    GPIO_Init(GPIOB, &GPIO_InitStructure);
  #else 
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1 | RCC_APB2Periph_GPIOA | RCC_APB2Periph_AFIO, ENABLE);//打开串口1和对应IO时钟      
...
void DMA_Configuration(void)
{
    ...
    DMA_DeInit(DMA1_Channel3); 	//DMA1通道5配置   
    ...
    DMA_Cmd(DMA1_Channel3,ENABLE);     //使能通道5  
}
...
/////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //USART_DMACmd(USART2,USART_DMAReq_Tx,ENABLE);	//使能UART2采用DMA方式发送
//////////////////////////////////////////////////////////////////////////////		
    USART_InitStructure.USART_WordLength = USART_WordLength_8b;    
    USART_InitStructure.USART_StopBits = USART_StopBits_1;    
    USART_InitStructure.USART_Parity = USART_Parity_No;    
...
{  
    ...
    {		
     ...
     //printf("\r\n%d",Length);	
    DMA1_Channel3->CNDTR = UART_RX_LEN;//重装填,并让接收地址偏址从0开始
